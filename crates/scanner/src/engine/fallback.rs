...
impl CompiledScanner {
    ...
    pub(crate) fn match_confidence(
        ...
        let raw_conf = match crate::checksum::validate_checksum(credential) {
            crate::checksum::ChecksumResult::Valid => raw_conf.max(0.95),
            crate::checksum::ChecksumResult::Invalid => raw_conf * 0.2,
            crate::checksum::ChecksumResult::NotApplicable => raw_conf,
        };
